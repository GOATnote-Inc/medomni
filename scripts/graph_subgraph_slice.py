...
NODES: list[dict] = [
    ...
    {"id": "drug:aspirin", "type": "Drug", "label": "Aspirin (low-dose)", "register": "physician"},
    {
        ...
        "type": "Drug",
        "label": "Atorvastatin (statin class)",
        "register": "physician",
    },
    ...
    {
        "id": "drug:mirena_lng_ius",
        "type": "Drug",
        "label": "Levonorgestrel IUS (Mirena)",
        "register": "physician",
    },
    # Vaccines
    {
        "id": "vaccine:gardasil_9",
        "type": "Vaccine",
        "label": "Gardasil-9 (9vHPV)",
        "register": "patient",
    },
    # Conditions / Outcomes
    {
        "id": "condition:invasive_breast_cancer",
        "type": "Condition",
        "label": "Invasive breast cancer",
    },
    {
        "id": "condition:bone_recurrence",
        "type": "Condition",
        "label": "Bone recurrence (breast cancer)",
    },
    {"id": "condition:colorectal_cancer", "type": "Condition", "label": "Colorectal cancer"},
    {
        "id": "condition:prostate_cancer_high_grade",
        "type": "Condition",
        "label": "High-grade prostate cancer",
    },
    ...
    {
        "id": "condition:atypical_femur_fracture",
        "type": "Condition",
    ...
    {
        "id": "condition:endometrial_hyperplasia",
        "type": "Condition",
        "label": "Endometrial hyperplasia / cancer",
    },
    # Trials
    ...
    {
        "id": "trial:cochrane_romero_2020",
        "type": "Trial",
        "label": "Cochrane Romero 2020 (LNG-IUS + tamoxifen)",
    },
    # Guidelines / Regulators
    {
        "id": "guideline:uspstf_2019_breast_meds",
        "type": "Guideline",
        "label": "USPSTF 2019 breast cancer meds",
    },
    {
        "id": "guideline:uspstf_2022_aspirin",
        "type": "Guideline",
        "label": "USPSTF 2022 aspirin (CVD/CRC)",
    },
    {
        "id": "guideline:uspstf_2022_statin",
        "type": "Guideline",
        "label": "USPSTF 2022 statin primary prevention",
    },
    {
        "id": "guideline:uspstf_2021_tobacco",
        "type": "Guideline",
        "label": "USPSTF 2021 tobacco cessation",
    },
    ...
    {
        "id": "regulator:fda_2018_gardasil9_age45",
        "type": "Regulator",
        "label": "FDA 2018 Gardasil-9 expansion to age 45",
    },
    {
        "id": "regulator:fda_2011_5ari_high_grade",
        "type": "Regulator",
        "label": "FDA 2011 5-ARI high-grade warning",
    },
    # Populations
    ...
    {
        "id": "pop:age_27_45_unvax",
        "type": "Population",
        "label": "Adults 27-45 not adequately HPV-vaccinated",
    },
    {
        "id": "pop:hr_pos_early_bc_on_ai",
        "type": "Population",
        "label": "HR+ early breast cancer on aromatase inhibitor",
    },
    # Tests / Concepts
    {"id": "test:dexa", "type": "Test", "label": "DEXA bone-density scan"},
    {"id": "test:psa", "type": "Test", "label": "PSA (prostate-specific antigen)"},
    {
        "id": "test:cervical_screening",
        "type": "Test",
        "label": "Cervical cancer screening (Pap / HPV)",
    },
    {"id": "test:dental_eval", "type": "Test", "label": "Pre-treatment dental evaluation"},
    {
        "id": "concept:diminished_benefit_prior_exposure",
        "type": "Concept",
        "label": "Diminished benefit with prior exposure",
    },
    {
        "id": "concept:premenopausal_no_signal",
        "type": "Concept",
        "label": "EBCTCG: no premenopausal benefit",
    },
]
...
EDGES: list[tuple[str, str, str, int, str, str]] = [
    ...
    (
        "drug:tamoxifen",
        "condition:invasive_breast_cancer",
        "indicates",
        PERSONA_ALL,
        "A",
        "USPSTF-2019; NSABP P-1",
    ),
    (
        "drug:tamoxifen",
        "condition:endometrial_hyperplasia",
        "increases_risk_of",
        PERSONA_PHYSICIAN | PERSONA_NURSE,
        "A",
        "ACOG #601 / Cochrane Romero 2020",
    ),
    (
        "drug:mirena_lng_ius",
        "condition:endometrial_hyperplasia",
        "protects_against",
        PERSONA_PHYSICIAN | PERSONA_NURSE | PERSONA_PATIENT,
        "A",
        "Cochrane Romero 2020",
    ),
    (
        "trial:cochrane_romero_2020",
        "drug:mirena_lng_ius",
        "evidenced_by",
        PERSONA_PHYSICIAN,
        "A",
    ...
    (
        "vaccine:gardasil_9",
        "condition:cervical_cancer",
        "indicates",
        PERSONA_ALL,
        "A",
        "ACIP-MMWR-2019; FUTURE I/II",
    ),
    (
        "guideline:acip_2019_hpv",
        "pop:age_27_45_unvax",
        "shared_clinical_decision_making",
        PERSONA_ALL,
        "A",
        "ACIP 2019 MMWR",
    ),
    (
        "regulator:fda_2018_gardasil9_age45",
        "vaccine:gardasil_9",
        "expanded_indication_to_age_45",
        PERSONA_ALL,
        "A",
        "FDA 2018 supplemental approval",
    ),
    (
        "trial:future_i_ii",
        "vaccine:gardasil_9",
    ...
    (
        "vaccine:gardasil_9",
        "test:cervical_screening",
        "complements_not_replaces",
        PERSONA_ALL,
        "A",
    ...
    (
        "vaccine:gardasil_9",
        "concept:diminished_benefit_prior_exposure",
        "modulated_by",
        PERSONA_PATIENT | PERSONA_FAMILY | PERSONA_PHYSICIAN,
        "A",
        "ACIP 2019 / NCI",
    ),
    (
    ...
    (
        "drug:zoledronic_acid",
        "condition:bone_recurrence",
        "reduces_in",
        PERSONA_PHYSICIAN | PERSONA_NURSE,
        "A",
        "EBCTCG 2015",
    ...
    (
        "guideline:asco_2017_bma",
        "pop:hr_pos_early_bc_on_ai",
        "recommends_for",
        PERSONA_PHYSICIAN,
        "A",
        "Dhesy-Thind JCO 2017",
    ),
    (
        "drug:zoledronic_acid",
        "condition:onj",
        ...
        PERSONA_PHYSICIAN | PERSONA_NURSE | PERSONA_PATIENT,
        "A",
        "FDA bisphosphonate safety",
    ),
    (
        "drug:zoledronic_acid",
        "condition:atypical_femur_fracture",
        "rare_adverse_event",
        PERSONA_PHYSICIAN | PERSONA_NURSE,
        "A",
        "FDA bisphosphonate safety",
    ...
    ("drug:aspirin", "pop:lynch_syndrome", "indicates_in", PERSONA_PHYSICIAN, "A", "CAPP2"),
    ("drug:aspirin", "pop:elderly", "no_benefit_in", PERSONA_PHYSICIAN, "A", "ASPREE"),
    # ---- 5-ARI / prostate axis ----
    ...
    (
        "regulator:fda_2011_5ari_high_grade",
        "drug:finasteride",
        "warns_about",
        PERSONA_PHYSICIAN,
        "A",
        "FDA 2011 class warning",
    ),
    (
        "regulator:fda_2011_5ari_high_grade",
        "drug:dutasteride",
    ...
    (
        ...
        PERSONA_PHYSICIAN,
        "A",
        "PCPT PSA-doubling rule",
    ),
    # ---- Statin / cancer axis ----
    (
        "guideline:uspstf_2022_statin",
        "drug:atorvastatin",
        "recommends_for",
        PERSONA_PHYSICIAN,
        "A",
    ...
    (
        ...
        "condition:ascvd",
        "reduces",
        PERSONA_PHYSICIAN | PERSONA_PATIENT,
        "A",
        "USPSTF 2022; CTT meta",
    ),
    (
        "trial:jupiter",
        "drug:atorvastatin",
    ...
    (
        "guideline:uspstf_2021_tobacco",
        "condition:tobacco_dependence",
        "recommends_for",
        PERSONA_PHYSICIAN | PERSONA_NURSE,
        "A",
        "USPSTF 2021",
...
def expand_subgraph(G, *, seeds: list[str], persona: str = "patient", hops: int = 2):
    ...
    _import_nx()  # ensure networkx is importable
