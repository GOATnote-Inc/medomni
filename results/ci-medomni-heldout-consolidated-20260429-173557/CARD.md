...
- **Score**: `0.385 ± 0.000` (mean ± 95% half-width across N=3 trial aggregates)
- **Wall time**: 190 s
- **Run ID**: `6317968b`
- **Generated**: 2026-04-30T00:39:07Z
...
| accuracy | +0.354 |
| completeness | +0.343 |
| context_awareness | +0.145 |
| instruction_following | +0.479 |
| communication_quality | +0.563 |

## Comparison

| Stack | Score (mean ± 95% HW) | N trials | Date |
|---|---|---|---|
| **nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning-NVFP4** (sovereign, NVIDIA B300 SXM6 AC, this run) | `0.385 ± 0.000` | 3 | 2026-04-30 |
