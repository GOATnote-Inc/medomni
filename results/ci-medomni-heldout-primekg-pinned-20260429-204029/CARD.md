...
**Sovereign sweep — HealthBench Hard, 6-example subset, N=3 trials.**

## Result (this run)

- **Score**: `0.358 ± 0.000` (mean ± 95% half-width across N=3 trial aggregates)
- **Wall time**: 175 s
- **Run ID**: `8b862823`
- **Generated**: 2026-04-30T03:43:25Z
...
| accuracy | +0.337 |
| completeness | +0.283 |
| context_awareness | +0.219 |
| instruction_following | +0.256 |
| communication_quality | +0.507 |

## Comparison

| Stack | Score (mean ± 95% HW) | N trials | Date |
|---|---|---|---|
| **nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning-NVFP4** (sovereign, NVIDIA B300 SXM6 AC, this run) | `0.358 ± 0.000` | 3 | 2026-04-30 |
...
- **Judge incompleteness**: 0 rubric items recused across 18 example-trials (avg 0.0 per example, 0 of 18 example-trials had at least one recusal). The judge JSON-parser couldn't extract a verdict on those items (malformed model output, retries exhausted). Score is computed over the successfully judged subset; a tighter judge prompt or `response_format=json_object` is the first R1.5 polish.
...
- Manifest: `/Users/kiteboard/prism42-nemotron-med/corpus/clinical-fixtures-heldout-phase24`
